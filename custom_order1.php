        ...
        <center><h5 class="card-title">Custom Order View</h5></center>
          <div class="table-responsive">
            <table id="zero_config" class="table table-striped table-bordered">
              ...
              {
              ?> 
            <a href="print.php?pr=custom_order.php&option=view" target="_blank"><button class="btn btn-primary">Print</button></a>              <br><br>
              <?php
              }
              ?>
            <thead>
...
$sqlview = "SELECT image_id,order_id,accept_price,status FROM custom_order";
        ...
        while ($rowview = mysqli_fetch_assoc($resultview))
        {
            ...
            if(isset($_GET["pg"]))
            {
            echo '<a href="index.php?pg=customs_order.php&option=fullview&pk1='.$rowview["image_id"].'&pk2='.$rowview["order_id"].'"><button class="btn btn-success">View</button></a> ';
            echo '<a href="index.php?pg=customs_order.php&option=edit&pk1='.$rowview["image_id"].'&pk2='.$rowview["order_id"].'"><button class="btn btn-info">Edit</button></a> ';
