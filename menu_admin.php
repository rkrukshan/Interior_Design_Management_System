...
$adminconfirmpricenotification=0;
...
while($rowview=mysqli_fetch_assoc($resultview))
{
	...
	if (mysqli_num_rows($resultcheckorderprocess)==0)
	{
		...
		{
			$adminconfirmpricenotification++;
		}
	}
}
$totalnotification=$totalnotification+$adminconfirmpricenotification;
...
<ul class="navbar-nav">
	...
	<li class="nav-item dropdown">
		...
		<a class="dropdown-item" href="index.php?pg=notification_adminconfirmprice.php">Custom Order Price(<?php echo $adminconfirmpricenotification; ?>)</a>
	...
	<li class="nav-item dropdown">
		...
		<div class="dropdown-menu" aria-labelledby="navbarDropdown_2">
			...
			<a class="dropdown-item" href="index.php?pg=report.php&option=order_status">Order Status Report</a>
			<a class="dropdown-item" href="index.php?pg=report.php&option=order_process">Order Process Report</a>
			<a class="dropdown-item" href="index.php?pg=report.php&option=order_product">Order Product Report</a>
			<a class="dropdown-item" href="index.php?pg=report.php&option=purchase">Order purchase Report</a>
			<a class="dropdown-item" href="index.php?pg=report.php&option=purchase_paymode">Order Purchase Paymode Report</a>
			<a class="dropdown-item" href="index.php?pg=report.php&option=staffjoin">Staff Join Date Report</a>
			<a class="dropdown-item" href="index.php?pg=report.php&option=customer_age">Customer DOB Report</a>
